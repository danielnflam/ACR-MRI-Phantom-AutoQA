...
switch sequence
  case "localizer"
    DICOMDIR_PATH = "Z:\\MRI\\Old Aera\\20230608 Aera 52365\\Localizer"; # localizer
  case "T1"
...
if sequence == "localizer"
  geomAccuracy = ACR_test_GeometricAccuracy_localizer(phantom, image.array)
  saveas(gcf, cat(2, sequence, " geometric accuracy"), "png")
else
